...
- Implement `PercepetionFeatures` library and implement `ArucoDetector` class useful for localization problems. (See https://github.com/dic-iit/bipedal-locomotion-framework/pull/159)
